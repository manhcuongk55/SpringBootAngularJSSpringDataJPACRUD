...
LOCK TABLES `product_attribute_details` WRITE;
/*!40000 ALTER TABLE `product_attribute_details` DISABLE KEYS */;
INSERT INTO `product_attribute_details` VALUES (2,5,89000,NULL),(2,2,89000,NULL);
/*!40000 ALTER TABLE `product_attribute_details` ENABLE KEYS */;
UNLOCK TABLES;
